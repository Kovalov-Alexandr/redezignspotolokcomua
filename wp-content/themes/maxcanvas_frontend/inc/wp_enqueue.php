...
if ( ! function_exists( 'maxcanvas_child_scripts_styles' ) ):
  ...
  function maxcanvas_child_scripts_styles() {
    ...
    // Core styles
    wp_enqueue_style( 'global-style', get_stylesheet_directory_uri() . '/styles/front-end-global.css' );
    wp_enqueue_style( 'responsive-style', get_stylesheet_directory_uri() . '/styles/front-end-responsive.css' );
    ...
    // Core styles
    if (is_front_page()):
        wp_enqueue_style('home', get_stylesheet_directory_uri() . '/styles/front-end-home.css');
    elseif (is_home() || is_single() || is_archive()):
        wp_enqueue_style('blog', get_stylesheet_directory_uri() . '/styles/front-end-blog.css');
    endif;
